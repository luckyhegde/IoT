...
const char* KEY = "taEhEQRbu1Vs5DaugxUR7zY3HpwjwL0tIHOXX4d";    // event hub access key 
const char* KEY_NAME = "confroom_policy";                 // event hub key name  ( policy name) 
const char* HOST = "IoTPocConfRoom.servicebus.windows.net";              // event hub name (name of service bus)
const char* END_POINT = "/nodemcu/messages";                 // name of the evnthub which we create inside eventhub namespace
